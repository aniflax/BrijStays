...
export const Route = createFileRoute("/director")({
  head: () => ({
    meta: [
      { title: "Director's Desk — Brij Stays, Indore" },
      {
        name: "description",
        content:
          "A personal message from the Managing Director of Brij Stays on how and why we build in Indore.",
      },
      { property: "og:title", content: "Director's Desk — Brij Stays" },
      {
