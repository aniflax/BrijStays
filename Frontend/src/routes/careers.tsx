...
export const Route = createFileRoute("/careers")({
  head: () => ({
    meta: [
      { title: "Careers at Brij Stays — Build in Indore" },
      {
        name: "description",
        content:
          "Open roles in design, construction, sales and marketing at Brij Stays, Indore. Small team, long horizons, high specification.",
      },
      { property: "og:title", content: "Careers — Brij Stays" },
      {
